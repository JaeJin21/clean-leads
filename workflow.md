...
- 3단계 스텝 폼 구현 (Framer Motion 슬라이드 애니메이션)
  - **Step 1**: 청소 종류 선택 — 7종 (입주청소 / 퇴거청소 / 거주청소 / 원룸청소 / 사무실청소 / 특수청소 / 그 외 기타 청소)
...
- **Hero**: 그라디언트 배경, 헤드카피, 신뢰 배지 4개
  - 보험 가입 업체 인증 / 평균 만족도 4.9점 / 누적 매칭 12,000건+ / 100% 무료 견적 비교
- **Booking Form 섹션**: 2만원 할인 쿠폰 안내 + `BookingForm` 컴포넌트 삽입
- **How it works**: 3단계 이용 방법 카드
- **Reviews**: 실제 후기 3개 (서울/경기/부산)
